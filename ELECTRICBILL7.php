...
<center>
    ...
    <form method="post">
        <table border="0">
            <tr>
                <td>Enter previous reading:<input type="text" name="num1" placeholder="Enter previous reading"/>
                </td>
            </tr>
            <tr>
            <td>Enter present reading: <input type="text" name="num2"  placeholder="Enter present reading"/>
                </td>
            </tr>
            <tr>
